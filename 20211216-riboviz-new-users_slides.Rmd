...
- the [example-datasets repository](https://github.com/riboviz/example-datasets) holds configuration files for public datasets published from a wide variety of species across several kingdoms, and also holds the annotation/contaminants files required for those datasets.   
- For smaller test dataset configs, view the example configuration files for the vignette datasets in the [`vignette/`](https://github.com/riboviz/riboviz/tree/main/vignette) folder. 
